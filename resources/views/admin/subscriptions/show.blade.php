...
<div class="bg-white rounded-lg shadow p-3 lg:p-6">
    <div class="mb-4 lg:mb-6 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3">
        <h3 class="text-lg lg:text-xl font-semibold">Informations abonnement</h3>
        <div class="flex flex-col sm:flex-row gap-2 w-full sm:w-auto">
            <a href="{{ route('admin.subscriptions.edit', $subscription) }}" class="bg-green-600 text-white px-3 lg:px-4 py-2 rounded hover:bg-green-700 text-sm lg:text-base text-center">
                <i class="fas fa-edit mr-2"></i>Modifier
            </a>
            <a href="{{ route('admin.subscriptions.index') }}" class="bg-gray-600 text-white px-3 lg:px-4 py-2 rounded hover:bg-gray-700 text-sm lg:text-base text-center">
                Retour
            </a>
        </div>
    </div>
